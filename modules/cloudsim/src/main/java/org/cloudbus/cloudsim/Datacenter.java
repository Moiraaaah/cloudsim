...
public class Datacenter extends SimEntity {
    ...
    public Datacenter(String name, Datacenter copy) throws Exception {
        super(name);
        setCharacteristics(copy.getCharacteristics());
        setVmAllocationPolicy(copy.getVmAllocationPolicy());
        setLastProcessTime(copy.getLastProcessTime());
        setStorageList(copy.getStorageList());
        setVmList(copy.getVmList());
        setSchedulingInterval(copy.getSchedulingInterval());
    ...
    public String toString() {
        return getName() + ": Number of hosts: " + getHostList().size() + ", Architecture: " + characteristics.getOs()
                + " " + characteristics.getVmm() + " " + characteristics.getArchitecture() + ", Time Zone: "
                + characteristics.getTimeZone();
    }
}
